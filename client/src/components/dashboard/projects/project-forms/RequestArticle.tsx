...
const formSchema = z.object({
  numberOfArticles: z
    ...
    .max(100, {
      message: "Number of articles must be at most 100",
    }),
...
function RequestArticleForm() {
  ...
  const { createArticleRequest } = useProjectStore();

  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      setBtnLoading(true);
      await createArticleRequest(values);
  ...
  return (
    <>
              ...
              <FormItem>
                ...
                <FormControl>
                  <AntDSelect
                    ...
                    suffixIcon={
                      <CaretSortIcon color="grey" className="block" />
                    }
                    dropdownStyle={{
      ...
      <RequestSuccessDialogue open={openSuccessModal} onChange={() => {}} />
    </>
  );
}
